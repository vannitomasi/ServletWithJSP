 ...
 * @author vanni
 */
@WebServlet(name = "BoardgameCreateServlet", urlPatterns = {BusinessUtils.BOARDGAME_CREATE_URL_ROOT})
public class BoardgameCreateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        this.getServletContext().getRequestDispatcher(BusinessUtils.BOARDGAME_CREATE_PAGE_PATH).forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if(!BoardgameQuery.create(boardgame)) {
                errorMessage = BusinessUtils.getBoardgameErrorWithPhaseString("creating");
            }
        } catch (SQLException ex) {            
            errorMessage = ex.getMessage();
            Logger.getLogger(BoardgameUpdateServlet.class.getName()).log(Level.SEVERE, null, ex);
        ...
        if (errorMessage == null || errorMessage.isEmpty()) {
            ...
            request.getServletContext()
                    .getRequestDispatcher(BusinessUtils.BOARDGAME_CREATE_PAGE_PATH)
